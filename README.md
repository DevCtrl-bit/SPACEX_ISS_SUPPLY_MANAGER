...
### menu.py -> 
se compone por una sola función: imprimeMenu()->entero
...
### error.py -> 
este módulo utiliza a su vez menu.py, además haremos uso de la librería time para controlar el tiempo de retorno al menú principal tras mostrar un error.
